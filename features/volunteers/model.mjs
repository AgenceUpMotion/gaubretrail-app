...
export function selectVolunteers(state, editionId, { query = '', status = '', postId = '', sort = 'asc' } = {}) {
  const rows = state.volunteers.filter(volunteer => editionIds(state, volunteer).includes(editionId)).map(volunteer => {
